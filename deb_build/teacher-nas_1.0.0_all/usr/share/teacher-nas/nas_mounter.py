...
# deb 安装后资源路径（/usr/share/teacher-nas/assets/）
# 开发调试时若不存在则 fallback 到脚本同目录
_SYSTEM_ASSETS = Path("/usr/share/teacher-nas/assets")
_LOCAL_ASSETS  = Path(__file__).parent / "assets"
ASSETS_DIR  = _SYSTEM_ASSETS if _SYSTEM_ASSETS.exists() else _LOCAL_ASSETS
